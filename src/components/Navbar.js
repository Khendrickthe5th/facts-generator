...
function Navbar() {
    ...
    <div className="w-[full] h-[70px] dark:bg-transparent flex justify-center">
        <div className="w-[85%] h-[100%] flex justify-between items-end">
            ...
            <div ref={setDisplay} className="w-[90%] h-[100%] sm:w-[55%] absolute right-0 hidden bg-white dark:bg-black z-[20] shadow-md shadow-black">
                <div className="w-[85%] sm:w-[80%] h-[100%]">
                    ...
                    <span onClick={()=>{alert("Feature coming soon!")}} className="w-[100%] h-[70px] flex justify-center items-end font-font1 font-semibold text-[13px] sm:text-[21px] dark:text-white"><span href={void 0}>Random Quotes</span></span>
                    
                    <span className="w-[100] h-[calc(100%-140px)] text-[10px] sm:text-[15px] font-font1 font-normal flex items-end justify-center pb-[20px] dark:text-white"><p>Made with 💖 by Khendrick</p></span>
                </div>
            </div>
    </div>
    )
